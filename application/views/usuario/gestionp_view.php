                          ...
                          <table id="example" class="table table-hover">
                            <thead>
                                ...
                                <tbody class="table table-striped">
                                    ...
                                    <td>
                                    <STYLE>A {text-decoration: none;} </STYLE><a href="<?php echo base_url('editar-pedido/'. $pedido->_id); ?>" class="fa fa-edit" style="color: #0086F6;"></a>
                                    <a href="<?php echo base_url('eliminar-pedido/'. $pedido->_id); ?>"  class="fa fa-trash" style="color: #DC4646;"></a>
                                    <a href="<?php echo base_url(''). 'Pedidos'; ?>" class="fa fa-plus" style="color: purple;"></a>
                                    <a href="<?php echo base_url('pdf/fpdf.php')?>" class="fa fa-download" style="color: blue;"></a>     
                                    </td>
                                </tbody>
